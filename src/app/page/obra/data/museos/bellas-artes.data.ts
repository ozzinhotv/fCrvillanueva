...
export const MUSEO_DE_BELLAS_ARTES_DATA: ObraData = {
  category: 'Museos',
  work: 'Museo de Bellas Artes',
  hero: {
  ...
  introHtml: `
    <p>
      El Museo de Bellas Artes es una pieza clave de la Ciudad Universitaria. Aquí puedes
